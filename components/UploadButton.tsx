        ...
        >
          <div className='flex w-full h-full items-center justify-center'>
            <label
              ...
              className='flex flex-col w-full h-full items-center justify-center rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100'
            >
              ...
              {acceptedFiles && acceptedFiles[0] ? (
                <div className='flex bg-white max-w-xs rounded-md items-center overflow-hidden outline outline-[1px] outline-zinc-200 divide-x divide-zinc-200'>
